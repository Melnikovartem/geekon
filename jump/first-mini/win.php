...
if(isset($_POST["num"]) and isset($_POST["name"]) and isset($_POST["cvs"]) and isset($_POST["mail"])){
  if($_POST["num"]=="" or $_POST["name"]=="" or $_POST["cvs"]=="" or $_POST["mail"]==""){
    $ok = 0;
  }
}
else{
...
if ($ok == 1){
  ...
  echo "<h1>Ошибка:</h1> <h3>не все данные</h3>";
  echo "<br><form action = '/'><input type = 'submit' value = 'Назад' height = '1'/></form>";
}
?>
